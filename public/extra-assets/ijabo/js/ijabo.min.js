!(function (t) {
    ...
    c.extend(c.fn, {
        ...
        rules: function (t, e) {
            ...
            if (
                ...
                if (t)
                    switch (
                        ((n = (i = c.data(r.form, "validator").settings).rules),
                        (a = c.validator.staticRules(r)),
                        t)
                    ) {
                        case "add":
                ...
                return (
                    (l = c.validator.normalizeRules(
                        c.extend(
                            {},
                            c.validator.classRules(r),
                            c.validator.attributeRules(r),
                            c.validator.dataRules(r),
                            c.validator.staticRules(r)
                        ),
                        r
                    )).required &&
                        ((o = l.required),
                        delete l.required,
                        (l = c.extend({ required: o }, l))),
                    l.remote &&
                        ((o = l.remote),
                        delete l.remote,
                        (l = c.extend(l, { remote: o }))),
                    l
                );
            }
        },
        ...
        c.extend(c.validator, {
            ...
            prototype: {
                ...
                check: function (e) {
                    ...
                    a && ((l = a.call(e, l)), delete o.normalizer),
                    o)) {
            ...
            methods: {
                ...
                remote: function (n, a, t, o) {
                    ...
                    return (
                        ...
                        (this.settings.messages[a.name][o] = r.message),
                        (e = c.param(
                            c.extend(
                                { data: n },
    ...
    (function (t) {
        ...
        return (
            r.validator.addMethod(
                ...
                r.validator.format("Please enter {0} words or less.")
            ),
            r.validator.addMethod(
                "minWords",
                function (t, e, i) {
                ...
                r.validator.format("Please enter at least {0} words.")
            ),
            r.validator.addMethod(
                "rangeWords",
                function (t, e, i) {
                ...
                r.validator.format("Please enter between {0} and {1} words.")
            ),
            r.validator.addMethod(
                "abaRoutingNumber",
                function (t) {
            ...
            r.validator.addMethod(
                ...
                function (t, e) {
                    return (
                        this.optional(e) ||
                        r.validator.methods.bankaccountNL.call(this, t, e) ||
                        r.validator.methods.giroaccountNL.call(this, t, e)
                    );
                },
                    ...
                    for (i = 0; i < o.length; i++)
                        (n = parseInt(o[i], 10)),
                            i % 2 == 0
                                ...
                                : (r += n);
                    return (
                        (e = (10 - (r + l).toString().substr(-1)).toString()),
                        (e = 9 < parseInt(e, 10) ? "0" : e),
                        (t = "JABCDEFGHI".substr(e, 1).toString()),
                        a.match(/[ABEH]/)
                            ? s === e
                            : (!a.match(/[KPQS]/) && s === e) || s === t
                    );
                },
            ...
            r.validator.addMethod(
                ...
                function (t) {
                    ...
                    var e,
                        ...
                        o = 0,
                        s = t.charAt(0);
                    if (new Array(12).join(s) === t) return !1;
            ...
            r.validator.addMethod(
                ...
                r.validator.format("Please select no more than {0} files.")
            ),
            r.validator.addMethod(
                "maxsize",
                function (t, e, i) {
                ...
                r.validator.format("File size must not exceed {0} bytes each.")
            ),
            r.validator.addMethod(
                "maxsizetotal",
                function (t, e, i) {
            ...
            r.validator.addMethod(
                ...
                function (t, e, i) {
                    return (
                        this.optional(e) ||
                        !r.validator.methods.equalTo.call(this, t, e, i)
                    );
                },
            ...
            r.validator.addMethod(
                ...
                r.validator.format("Please fill at least {0} of these fields.")
            ),
            r.validator.addMethod(
            ...
            r.validator.addMethod(
                "strippedminlength",
                function (t, e, i) {
                    return r(t).text().length >= i;
                },
                r.validator.format("Please enter at least {0} characters")
            ),
            r.validator.addMethod(
                "time",
                function (t, e) {
                            ...
                            s.width > s.height
                                ? ((r.can.width = s.width),
                                  ...
                                  (r.can.style.height =
                                      ...
                                      "px"),
                                  (o.fillStyle = "#fff"),
                                  o.fillRect(0, 0, r.can.width, r.can.height),
                                  o.drawImage(
                                      s,
                                      0,
                                      0,
    ...
    (function (t, e) {
        ...
        var t = "undefined" != typeof window && void 0 !== window.document,
            s = t ? window : {},
            e = t && "ontouchstart" in s.document.documentElement,
            i = t && "PointerEvent" in s,
            d = "cropper",
            B = "n",
            k = "ne",
            S = "nw",
            ...
            Q = i ? "pointermove" : e ? "touchmove" : "mousemove",
            G = i
        ...
        var vt,
            ...
            wt =
                ...
                t &&
                    ...
                    s.addEventListener("test", i, e),
                    s.removeEventListener("test", i, e)),
                bt);
        function n(i, t, n, e) {
            ...
            t.trim()
                ...
                .forEach(function (n) {
                    ...
                    r.once &&
                        ...
                        ((t = o.listeners),
                        (l = function () {
                            delete a[n][s], o.removeEventListener(n, l, r);
                            for (
                                var t = arguments.length,
                                    e = new Array(t),
                                    i = 0;
                        ...
                        (a = void 0 === t ? {} : t)[n] || (a[n] = {}),
                        a[n][s] && o.removeEventListener(n, a[n][s], r),
                        (a[n][s] = l),
                        (o.listeners = a)),
                        o.addEventListener(n, l, r);
                });
        }
        function x(t, e, i) {
            var n;
        ...
        function E(t, e) {
            var i = t.pageX,
                t = t.pageY,
                n = { endX: i, endY: t };
            return e ? n : z({ startX: i, startY: t }, n);
        }
        function O(t, e) {
            var i,
                n = t.aspectRatio,
            ...
            t = {
                ...
                limitCanvas: function (t, e) {
                    ...
                    t &&
                        ...
                        1 < s
                            ...
                            : 0 < s &&
                              (t
                                  ? (t = Math.max(t, l ? o.width : 0))
                                  : i
                                  ? (i = Math.max(i, l ? o.height : 0))
                                  : l &&
                                    ((t = o.width) < (i = o.height) * r
                                        ? (t = i * r)
                                        : (i = t / r))),
                        (t = (r = O({ aspectRatio: r, width: t, height: i }))
                            .width),
                        (i = r.height),
                        (a.minWidth = t),
                        (a.minHeight = i),
                        ...
                        e &&
                            ((l ? 0 : 1) < s
                                ? ((r = n.width - a.width),
                                  (t = n.height - a.height),
                                  (a.minLeft = Math.min(0, r)),
                                  (a.minTop = Math.min(0, t)),
                                  (a.maxLeft = Math.max(0, r)),
                    ...
                    e &&
                        ...
                        (i =
                            90 == (e = Math.abs(e) % 180)
                                ...
                                : ((n = ((e % 90) * Math.PI) / 180),
                                  (i = Math.sin(n)),
                                  (a = r * (n = Math.cos(n)) + o * i),
                                  (r = r * i + o * n),
                                  90 < e
                                      ? { width: r, height: a }
                                      : { width: a, height: r })),
                        (n = s.width * ((o = i.width) / s.naturalWidth)),
                        (a = s.height * ((e = i.height) / s.naturalHeight)),
                        (s.left -= (n - s.width) / 2),
                        (s.top -= (a - s.height) / 2),
                        (s.width = n),
                        (s.height = a),
                        ...
                        (s.width > s.maxWidth || s.width < s.minWidth) &&
                            (s.left = s.oldLeft),
                        ...
                        (s.left = Math.min(
                            Math.max(s.left, s.minLeft),
                            s.maxLeft
                        )),
                        (s.top = Math.min(Math.max(s.top, s.minTop), s.maxTop)),
                        (s.oldLeft = s.left),
                        (s.oldTop = s.top),
                        v(
                            this.canvas,
                            g(
                                ...
                                C({ translateX: s.left, translateY: s.top })
                            )
                        ),
                        this.renderImage(t),
                        this.cropped &&
                ...
                limitCropBox: function (t, e) {
                    ...
                    t &&
                        ...
                        e &&
                            (l
                                ? ((r.minLeft = Math.max(0, s.left)),
                                  (r.minTop = Math.max(0, s.top)),
                                  (r.maxLeft =
                                      Math.min(o.width, s.left + s.width) -
                                      r.width),
                                  (r.maxTop =
                                      Math.min(o.height, s.top + s.height) -
                                      r.height))
                                : ((r.minLeft = 0),
                                  (r.minTop = 0),
                ...
                output: function () {
                    this.preview(), x(this.element, Y, this.getData());
                },
            },
            i = {
                ...
                preview: function () {
                    ...
                    this.cropped &&
                        ...
                        (v(
                            ...
                            g(
                                { width: d, height: c },
                                C(g({ translateX: -u, translateY: -h }, s))
                            )
                        ),
            ...
            e = {
                bind: function () {
                    ...
                    m(e.cropstart) && w(t, X, e.cropstart),
                        ...
                        m(e.cropend) && w(t, U, e.cropend),
                        m(e.crop) && w(t, Y, e.crop),
                ...
                unbind: function () {
                    ...
                    m(e.cropstart) && n(t, X, e.cropstart),
                        ...
                        m(e.cropend) && n(t, U, e.cropend),
                        m(e.crop) && n(t, Y, e.crop),
                        ...
                        n(t.ownerDocument, Q, this.onCropMove),
                        n(t.ownerDocument, G, this.onCropEnd),
            ...
            Tt = {
                ...
                cropMove: function (t) {
                    ...
                    !this.disabled &&
                        ...
                        (t.changedTouches
                            ? D(t.changedTouches, function (t) {
                                  g(e[t.identifier] || {}, E(t, !0));
                              })
                            : g(e[t.pointerId || 0] || {}, E(t, !0)),
                        this.change(t));
                },
                cropEnd: function (t) {
                    var e, i;
            ...
            Pt = {
                change: function (t) {
                    ...
                    var w,
                        ...
                        C,
                        E = o[Object.keys(o)[0]],
                        A = { x: E.endX - E.startX, y: E.endY - E.startY };
                    switch (s) {
                        case "all":
                            (l += A.x), (d += A.y);
                            break;
            ...
            Dt = {
                ...
                enable: function () {
                    return (
                        this.ready &&
                            this.disabled &&
                            ((this.disabled = !1), F(this.cropper, j)),
                        this
                    );
                },
                disable: function () {
                    return (
                        this.ready &&
                            !this.disabled &&
                            ((this.disabled = !0), b(this.cropper, j)),
                        this
                    );
                },
                destroy: function () {
                    ...
                    if (
                        ...
                        i
                            ? ((t = this.pointers),
                              ...
                              (r.left -=
                                  (s - l) * ((t.pageX - c.left - r.left) / l)),
                              (r.top -=
                                  (u - d) * ((t.pageY - c.top - r.top) / d)))
                            : f(e) && h(e.x) && h(e.y)
                            ? ((r.left -= (s - l) * ((e.x - r.left) / l)),
                              (r.top -= (u - d) * ((e.y - r.top) / d)))
                            : ((r.left -= (s - l) / 2), (r.top -= (u - d) / 2)),
                            (r.width = s),
                            (r.height = u),
                            this.renderCanvas(!0);
                    }
                ...
                getCroppedCanvas: function (t) {
                        ...
                        i =
                            ...
                            (v =
                                void 0 === (v = t.imageSmoothingQuality)
                                    ? "low"
                                    : v),
                            (l = void 0 === (l = t.maxWidth) ? 1 / 0 : l),
                            (d = void 0 === (d = t.maxHeight) ? 1 / 0 : d),
                            (i = void 0 === (i = t.minWidth) ? 0 : i),
                            (n = void 0 === (n = t.minHeight) ? 0 : n),
                            (S = document.createElement("canvas")),
                            (k = S.getContext("2d")),
                            (h = O({ aspectRatio: o, width: l, height: d })),
                            (o = O(
                                { aspectRatio: o, width: i, height: n },
                                "cover"
                            )),
                            (u = Math.min(h.width, Math.max(o.width, u))),
                            (h = Math.min(h.height, Math.max(o.height, s))),
                            (o = O({ aspectRatio: B, width: l, height: d })),
                            (s = O(
                                { aspectRatio: B, width: i, height: n },
                                "cover"
                            )),
                            (l = Math.min(o.width, Math.max(s.width, a))),
                            (d = Math.min(o.height, Math.max(s.height, r))),
                            (B = [-l / 2, -d / 2, l, d]),
                            (S.width = L(u)),
                            (S.height = L(h)),
                            (k.fillStyle = c),
                    ...
                    var n = this.getData(),
                        ...
                        h = O({
                            aspectRatio: d,
                            width: t.width || (1 != l ? i.width : s),
                            height: t.height || (1 != l ? i.height : r),
                        }),
                        p = h.width,
                        f = h.height,
                        ...
                        e =
                            ...
                            y <= 0 || n <= -r || k < n
                                ...
                                ? ((C = -n),
                                  ...
                                  (A = w = Math.min(k, r + n)))
                                : n <= k &&
                                  ((C = 0), (A = w = Math.min(r, k - n))),
                            [S, n, y, w]);
                    return (
                        0 < E &&
                            0 < A &&
                            e.push(x * (d = p / s), C * d, E * d, A * d),
                        g.drawImage.apply(
                            g,
                            [i].concat(
                                $(
                    ...
                    },
                    {
                        ...
                        value: function (i) {
                            ...
                            1 < a &&
                                ...
                                e.scalable && ((n.scaleX = s), (n.scaleY = r)),
                                this.clone();
                        },
                    },
                    {
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            this.sized &&
                                ...
                                e.background && b(a, "".concat(d, "-bg")),
                                e.highlight || b(l, W),
                                e.cropBoxMovable && (b(l, c), y(l, u, "all")),
                                e.cropBoxResizable ||
                                    (b(
                                        r.getElementsByClassName(
                                            "".concat(d, "-line")
        ...
        return g(A.prototype, t, i, e, Tt, Pt, Dt), A;
    }),
    (function () {
        function r(i, t) {
            function u() {
            ...
            function e(t, e) {
                ...
                function i() {
                    (d.style.width = l.offsetWidth + 10 + "px"),
                        (d.style.height = l.offsetHeight + 10 + "px"),
                ...
                function a() {
                    (t.offsetWidth == o && t.offsetHeight == s) ||
            ...
            if (a) for (var o = 0, s = i.length; o < s; o++) e(i[o], t);
            else e(i, t);
            this.detach = function () {
                if (a) for (var t = 0, e = i.length; t < e; t++) r.detach(i[t]);
                else r.detach(i);
            };
        }
        (r.detach = function (t) {
                    ...
                    (u.initialized = !0),
                        ...
                        t.each(function () {
                            ...
                            a.stickySidebar.css("padding-top", 1),
                                ...
                                (s = a.stickySidebar.outerHeight() - s - o),
                                0 == o
    ...
    (function (t, e) {
        ...
        function x(t) {
            console.error("".concat(Y, " ").concat(t));
        }
        function W(t) {
        ...
        function m(e, t, i) {
            l(e.classList).forEach(function (t) {
                -1 === q(A).indexOf(t) &&
                    -1 === q(n).indexOf(t) &&
        ...
        var Y = "SweetAlert2:",
            ...
            C = function (t) {
                console.warn("".concat(Y, " ").concat(t));
            },
            U = [],
            V = function (t) {
                -1 === U.indexOf(t) && (U.push(t), C(t));
            },
            r = function (t, e) {
                V(
                    '"'
        ...
        function K(t, e) {
            ...
            switch (e) {
                ...
                case "file":
                    return g(t, A[e]);
                case "checkbox":
                    return t.querySelector(".".concat(A.checkbox, " input"));
                case "radio":
                    return (
                        t.querySelector(
                ...
                case "range":
                    return t.querySelector(".".concat(A.range, " input"));
                default:
                    return g(t, A.input);
            }
        }
        ...
        function J() {
            return t(A["validation-message"]);
        }
        function u() {
            return pt("." + A.actions + " ." + A.confirm);
        }
        function h() {
            return pt("." + A.actions + " ." + A.cancel);
        }
        function p() {
            return t(A.actions);
        }
        ...
        function rt() {
            for (var t = ft(), e = 0; e < t.length; e++) D(t[e]);
        }
        function lt() {
            for (
                var t = F(),
            ...
            n.progressSteps && n.progressSteps.length
                ? (P(a),
                  ...
                  n.progressSteps.forEach(function (t, e) {
                      ...
                      M(i, A["progress-step"]),
                          (i.innerHTML = t),
                          e === o && M(i, A["active-progress-step"]),
                          a.appendChild(i),
                          e !== n.progressSteps.length - 1 &&
                              ((t = document.createElement("li")),
                              M(t, A["progress-step-line"]),
        ...
        var ut,
            ...
            g = function (t, e) {
                for (var i = 0; i < t.childNodes.length; i++)
                    if (B(t.childNodes[i], e)) return t.childNodes[i];
            },
            P = function (t) {
                var e =
                    1 < arguments.length && void 0 !== arguments[1]
            ...
            L = function () {
                return document.body.querySelector("." + A.container);
            },
            pt = function (t) {
                var e = L();
            ...
            ft = function () {
                var t = F();
                return l(t.querySelectorAll("." + A.icon));
            },
            mt = function () {
                return t(A["progress-steps"]);
            },
            gt = function () {
                return (
                    !vt() && !document.body.classList.contains(A["no-backdrop"])
                );
            },
            vt = function () {
                return document.body.classList.contains(A["toast-shown"]);
            },
            bt = '\n <div aria-labelledby="'
                .concat(A.title, '" aria-describedby="')
                .concat(A.content, '" class="')
                ...
                (e = L()) &&
                    ...
                    at()
                        ...
                        : (((e = document.createElement("div")).className =
                          ...
                          (a = e.querySelector(".".concat(A.range, " output"))),
                          (o = g(e, A.select)),
                          (s = e.querySelector(
                              ".".concat(A.checkbox, " input")
                          )),
                          (e = g(e, A.textarea)),
                          (t.oninput = f),
                          (i.onchange = f),
            ...
            wt = function (t) {
                var e = p(),
                    i = u(),
                    n = h();
                (t.showConfirmButton || t.showCancelButton ? P : D)(e),
                    ...
                    (i.className = A.confirm),
                    M(i, t.confirmButtonClass),
                    t.customClass && M(i, t.customClass.confirmButton),
                    (n.className = A.cancel),
                    M(n, t.cancelButtonClass),
                    t.customClass && M(n, t.customClass.cancelButton),
                    t.buttonsStyling
                        ? (M([i, n], A.styled),
            ...
            xt = function (t) {
                ...
                i &&
                    ...
                    M(i, t.customContainerClass);
            },
            Ct = function (t) {
                for (
                    var e = S().querySelector("#" + A.content),
                        i =
                            (t.html
                                ? (ot(t.html, e), P(e, "block"))
                                : t.text
                                ? ((e.textContent = t.text), P(e, "block"))
                                : D(e),
                            t),
                        n = S(),
                        a = [
                    ...
                    if ((r = K(n, a[s]))) {
                        for (var c in r.attributes)
                            r.attributes.hasOwnProperty(c) &&
                                "type" !== (c = r.attributes[c].name) &&
                                "value" !== c &&
                                r.removeAttribute(c);
                        for (var u in i.inputAttributes)
                            ("range" === a[s] && "placeholder" === u) ||
                                r.setAttribute(u, i.inputAttributes[u]);
                    }
                    (d.className = l),
                        i.inputClass && M(d, i.inputClass),
                        i.customClass && M(d, i.customClass.input),
                        D(d);
                }
                switch (i.input) {
                    case "text":
                    ...
                    case "url":
                        ...
                        break;
                    case "file":
                        o((r = g(n, A.file))), (r.type = i.input), P(r);
                        break;
                    case "range":
                        var h = g(n, A.range),
                    ...
                    case "radio":
                        ...
                        break;
                    case "checkbox":
                        (f = g(n, A.checkbox)), (p = K(n, "checkbox"));
                        (p.type = "checkbox"),
                            (p.value = 1),
                            (p.id = A.checkbox),
            ...
            Bt = function (t) {
                ...
                a(e, "width", t.width),
                    ...
                    (t.animation ? T : M)(e, A.noanimation);
            };
        function kt() {
            var t = F(),
                e = (t || b.fire(""), (t = F()), p()),
            ...
            Ft = Object.freeze({
                ...
                mixin: function (a) {
                    return (function (t) {
                        ...
                        function n() {
                            return (
                                y(this, n), $(this, s(n).apply(this, arguments))
                            );
                        }
                        return (
                        ...
                        !(function e(i, n) {
                            i < v.length
                                ? (document.body.setAttribute(
                                  ...
                                  s.fire(v[i]).then(function (t) {
                                      void 0 !== t.value
                                          ? (r.push(t.value), e(i + 1, n))
                ...
                stopTimer: function () {
                    return R.timeout && R.timeout.stop();
                },
                resumeTimer: function () {
                    return R.timeout && R.timeout.start();
                },
                ...
                increaseTimer: function (t) {
                    return R.timeout && R.timeout.increase(t);
                },
        ...
        function Ot() {
            var t = N.innerParams.get(this),
                e = N.domCache.get(this);
            t.showConfirmButton ||
                (D(e.confirmButton), t.showCancelButton) ||
                D(e.actions),
                T([e.popup, e.actions], A.loading),
        ...
        var Rt = function () {
            ...
            $t = function () {
                l(document.body.children).forEach(function (t) {
                    t === L() ||
                        (function (t, e) {
            ...
            n &&
                ...
                (e = function () {
                    ...
                    vt()
                        ...
                        : (new Promise(function (t) {
                          ...
                          R.keydownTarget.removeEventListener(
                              "keydown",
                              R.keydownHandler,
                              { capture: R.keydownListenerCapture }
                          ),
                          (R.keydownHandlerAdded = !1)),
                        ...
                        gt() &&
                            (null !== d.previousBodyPadding &&
                                ((document.body.style.paddingRight =
                                    d.previousBodyPadding + "px"),
                                (d.previousBodyPadding = null)),
                            B(document.body, A.iosfix) &&
                                ((t = parseInt(document.body.style.top, 10)),
                                T(document.body, A.iosfix),
                ...
                O && !B(n, A.noanimation)
                    ? n.addEventListener(O, function t() {
                          n.removeEventListener(O, t), B(n, A.hide) && e();
                      })
                    : e(),
                o(t || {}));
        }
        ...
        var Xt,
            Kt = Object.freeze({
                ...
                disableLoading: Ot,
                getInput: function (t) {
                    var e = N.innerParams.get(t || this);
                    return K(N.domCache.get(t || this).content, e.input);
                },
                close: e,
                closePopup: e,
                closeModal: e,
                ...
                getProgressSteps: function () {
                    return (
                        ...
                        N.innerParams.get(this).progressSteps
                    );
                },
                setProgressSteps: function (t) {
                    r("Swal.setProgressSteps()", "Swal.update()"),
                        (t = o({}, N.innerParams.get(this), {
                            progressSteps: t,
                        })),
                        N.innerParams.set(this, t),
                        dt(t);
                },
                ...
                _main: function (t) {
                    var e,
                        ...
                        i = t;
                    for (e in i)
                        Dt(e) || C('Unknown parameter "'.concat(e, '"')),
                            i.toast &&
                                -1 !== Pt.indexOf(e) &&
                                C(
                    ...
                    var n,
                        ...
                        b =
                            ((n = v).inputValidator ||
                                Object.keys(Ut).forEach(function (t) {
                                    n.input === t && (n.inputValidator = Ut[t]);
                                }),
                        ...
                        y = (N.domCache.set(this, b), ct(v), this.constructor);
                    return new Promise(function (t) {
                        for (
                            var e,
                                ...
                                o =
                                    (jt.swalPromiseResolve.set(g, t),
                                    v.timer &&
                                        (R.timeout = new Yt(function () {
                                            s("timer"), delete R.timeout;
                                        }, v.timer)),
                                    function () {
                                        var t = g.getInput();
                                        if (!t) return null;
                                ...
                                : ((e = !1),
                                  ...
                                  (b.container.onclick = function (t) {
                                      e
                                          ? (e = !1)
                                          : t.target === b.container &&
                                            E(v.allowOutsideClick) &&
                                            s(y.DismissReason.backdrop);
                                  })),
                            v.reverseButtons
                        ...
                        R.keydownHandlerAdded &&
                            ...
                            v.toast ||
                                    ...
                                    if (
                                        ...
                                        if ("Tab" === t.key) {
                                            ...
                                            [
                                                ...
                                                : ("Escape" !== t.key &&
                                                      "Esc" !== t.key) ||
                                                  !0 !== E(e.allowEscapeKey) ||
                                                  (t.preventDefault(),
                                                  s(y.DismissReason.esc));
                                    else
                                        t.target &&
                                            g.getInput() &&
                                            t.target.outerHTML ===
                                ...
                                (R.keydownTarget = v.keydownListenerCapture
                                    ? window
                                    : b.popup),
                                (R.keydownListenerCapture =
                                    v.keydownListenerCapture),
                                R.keydownTarget.addEventListener(
                                    "keydown",
                                    R.keydownHandler,
                                    { capture: R.keydownListenerCapture }
                                ),
                                (R.keydownHandlerAdded = !0)),
                            g.enableButtons(),
                            g.hideLoading(),
                            g.resetValidationMessage(),
                            (v.toast &&
                                ...
                                ? M
                                : T)(document.body, A["toast-column"]),
                            ...
                            null !== h.onBeforeOpen &&
                                ...
                                h.onBeforeOpen(f),
                            h.animation
                                ? (M(f, A.show), M(p, A.fade), T(f, A.hide))
                                : T(f, A.fade),
                            P(f),
                            (p.style.overflowY = "hidden"),
                            O && !B(f, A.noanimation)
                                ? f.addEventListener(O, function t() {
                                      f.removeEventListener(O, t),
                            ...
                            v.toast ||
                                (E(v.allowEnterKey)
                                    ? v.focusCancel && k(b.cancelButton)
                                        ? b.cancelButton.focus()
                                        : v.focusConfirm && k(b.confirmButton)
                                        ? b.confirmButton.focus()
                                        : m(-1, 1)
                                    : document.activeElement &&
                                      "function" ==
    ...
    (typeof define === "function" && define.amd
        ...
        function a(t) {
            ...
            var n = null,
                ...
                r = h("<div/>"),
                l = h(e.closeHtml),
                d = { intervalId: null, hideEta: null, maxHideTime: null },
                c = {
                    toastId: y,
                    state: "visible",
                    startTime: new Date(),
            ...
            return (
                ...
                t.title &&
                    (o.append(t.title).addClass(e.titleClass), a.append(o)),
                t.message &&
                    (s.append(t.message).addClass(e.messageClass), a.append(s)),
                e.closeButton &&
                    (l.addClass("toast-close-button").attr("role", "button"),
                    a.prepend(l)),
                e.progressBar && (r.addClass("toast-progress"), a.prepend(r)),
                a.hide(),
                ...
                a.hover(
                    ...
                    function () {
                        (0 < e.timeOut || 0 < e.extendedTimeOut) &&
                            ...
                            (d.maxHideTime = parseFloat(e.extendedTimeOut)),
                            (d.hideEta = new Date().getTime() + d.maxHideTime));
                    }
                ),
    ...
    (function (r) {
        ...
        r.fn.ijaboViewer = function (o) {
            const i = o.nameOnly || !1,
                s = (o.maxWidth, o.maxHeight, o.imageShape || null),
                n = o.allowedExtensions || null;
            r(o.preview).attr("src", r(o.preview).data("ijabo-default-img")),
                r(this).val(""),
                r(this).change(function (t) {
                    t.preventDefault();
                    const e = r(this)[0].files[0],
                        a = r(this);
                    var t = e.name.toLowerCase(),
                        t = t.substring(t.lastIndexOf(".") + 1);
                    null != n &&
                        -1 == r.inArray(t, o.allowedExtensions) &&
                        (r(o.preview).attr(
                            "src",
                            r(o.preview).data("ijabo-default-img")
                        ),
                        l(
                            o.onInvalidType,
                            "Invalid file type",
                        ...
                        r(a).val("")),
                        i
                            ? r(o.preview).html(e.name)
                            : (((t = new FileReader()).onload = function (i) {
                                  const t = new Image(),
                                      n = i.target.result;
                                  (t.src = n),
                                      (t.onload = function (t) {
    ...
    (function (i) {
        ...
        "use strict";
        o.notifyBar = function (t) {
            var e,
                i = parseInt(1e8 * Math.random(), 0),
                n = {},
                a = {},
                a = o.extend(
                    {
            ...
            (this.fn.showNB = function () {
                "function" == typeof a.onBeforeShow && a.onBeforeShow.call(),
                    o(this)
                        .stop()
                        .slideDown(e, function () {
                            "function" == typeof a.onShow && a.onShow.call();
                        });
            }),
                (this.fn.hideNB = function () {
                    "function" == typeof a.onBeforeHide &&
                        a.onBeforeHide.call(),
                        o(this)
                            .stop()
                            .slideUp(e, function () {
                                n.attr("id") === "__notifyBar" + i
                                    ? o(this).slideUp(e, function () {
                                          o(this).remove(),
                                              "function" == typeof a.onHide &&
                                                  a.onHide.call();
                                      })
                                    : o(this).slideUp(e, function () {
                                          "function" == typeof a.onHide &&
                ...
                a.jqObject
                    ? ((n = a.jqObject), (a.html = n.html()))
                    : (n = o("<div></div>")
                          .addClass("jquery-notify-bar")
                          .addClass(a.cssClass)
                          .attr("id", "__notifyBar" + i)),
                (t = o("<span></span>")
                    .addClass("notify-bar-text-wrapper")
                    .html(a.html)),
                n.html(t).hide(),
                n.attr("id");
            switch (a.animationSpeed) {
                case "slow":
                    e = 600;
                    break;
                case "default":
            ...
            return (
                o("body").prepend(n),
                a.close &&
                    (a.waitingForClose && (a.delay = Math.pow(10, 9)),
                    n.append(
                        o(
                            "<a href='#' class='notify-bar-close'>" +
                                a.closeText +
                                "</a>"
                        )
                    ),
                    o(".notify-bar-close").on("click", function (t) {
                        t.preventDefault(), n.hideNB();
                    })),
                0 < o(".jquery-notify-bar:visible").length
                    ? o(".jquery-notify-bar:visible")
                          .stop()
                          .slideUp(e, function () {
                              n.showNB();
                          })
                ...
                "bottom" === a.position
                    ? n.addClass("bottom")
                    : "top" === a.position && n.addClass("top"),
                n
            );
        };
    }),
    (function (t) {
        t.fn.konfirma = function (i) {
            (settings = t.extend(
                {
                    title: "Are you sure?",
                    html: null,
                ...
                swal
                    ...
                    .then(function (t) {
                        ...
                        t.value &&
                            settings.done &&
                            "" != settings.done &&
                            "undefined" != settings.done &&
                            ((t = i.done), (e = []), "function" == typeof t) &&
                            t(...e);
                    }),
                t(".swal2-popup").css("font-size", settings.fontSize);
        };
    })(jQuery),
    (function (e) {
        e.fn.notifa = function (t) {
            2 ==
            (settings = e.extend(
                {
                    cssClass: "success",
                ...
                : ((t = settings.title),
                  toastr.remove(),
                  "success" == settings.cssClass &&
                      toastr.success(settings.html, t, {
                          timeOut: settings.delay,
                      }),
                  "error" == settings.cssClass &&
                      toastr.error(settings.html, t, {
                          timeOut: settings.delay,
                      }),
                  "info" == settings.cssClass &&
                      toastr.info(settings.html, t, {
                          timeOut: settings.delay,
                      }),
                  "warning" == settings.cssClass &&
                      toastr.warning(settings.html, t, {
                          timeOut: settings.delay,
                      }));
        };
    })(jQuery);
