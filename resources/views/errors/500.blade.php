...
<head>
    ...
    <title>500 - Server Error | {{ config('app.name', 'GNRAW') }}</title>
...
<body>
    <div class="error-container">
        ...
        <p class="error-message">Something went wrong on our end. We're working to fix this issue. Please try again
            later.</p>
