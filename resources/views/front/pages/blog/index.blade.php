                            ...
                            <div class="card-box mb-30">
                                ...
                                <div class="list-group">
                                    <a href="{{ route('blog.index') }}"
                                        class="list-group-item d-flex align-items-center justify-content-between {{ !$selectedCategory ? 'active' : '' }}">All
                                        Categories <span
                                            class="badge badge-primary badge-pill">{{ $totalPostsCount }}</span>
                                    </a>
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            console.log('All dropdown buttons:', allButtons.length);

            const cardBoxes = document.querySelectorAll('.card-box');
            console.log('Card boxes found:', cardBoxes.length);
