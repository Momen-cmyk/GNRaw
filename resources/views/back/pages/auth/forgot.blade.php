...
@section('content')
    <div class="login-box bg-white box-shadow border-radius-10">
        ...
        <form
            action="{{ request()->is('supplier/*') ? route('supplier.send_password_reset_link') : route('admin.send_password_reset_link') }}"
            method="POST">
                ...
                <div class="col-5">
                    <div class="input-group mb-0">
                        <a class="btn btn-outline-primary btn-lg btn-block"
                            href="{{ request()->is('supplier/*') ? route('supplier.login') : route('admin.login') }}">Login</a>
                    </div>
                </div>
            </div>
        </form>
